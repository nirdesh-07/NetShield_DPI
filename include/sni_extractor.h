...
public:
    ...
    static compat::optional<std::string> extract(const uint8_t* payload, size_t length);
...
public:
    ...
    static compat::optional<std::string> extractQuery(const uint8_t* payload, size_t length);
